...
function dePalabrasAFrase(palabras) {
   ...
   // Tu código:
   var pablabraSeparada = palabras.join(" ")
   return(pablabraSeparada)
}
...
function promedioResultadosTest(resultadosTest) {
   ...
   let promedio = resultadosTest.reduce((acumulador, elemento)=> acumulador + elemento, 0)
...
function cuentoElementos(array) {
   ...
   // Tu código:
   resultado = array.filter((num)=> num > 18)
